...
function showDiv(select){
    ...
    if(select.value==='Chile'){
        document.getElementById('div_comuna_chile').style.display = "block";
    } else{
        document.getElementById('div_comuna_chile').style.display = "none";
    }
}

function showQaTextArea(){
    // mostrar qa extra abilities
    const targetDiv = document.getElementById("div-extra-abilities");
    const checkbox_status = document.getElementById("is-Qa");
